...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.fetch.allowedDomains":
    "Optional domain allowlist for web_fetch (exact domains or parent-domain suffix matches).",
  "tools.web.fetch.maxChars": "Max characters returned by web_fetch (truncated).",
  "tools.web.fetch.maxCharsCap":
    "Hard cap for web_fetch maxChars (applies to config and tool calls).",
  "tools.web.fetch.timeoutSeconds": "Timeout in seconds for web_fetch requests.",
  "tools.web.fetch.requestsPerMinute": "Optional request budget per minute for web_fetch.",
  "tools.web.fetch.requestsPerDay": "Optional request budget per day for web_fetch.",
  ...
  "agents.defaults.compaction":
    "Compaction tuning for when context nears token limits, including model selection, history share, reserve headroom, and pre-compaction memory flush behavior. Use this when long-running sessions need stable continuity under tight context windows.",
  "agents.defaults.compaction.model":
    "Model override used specifically for compaction turns (provider/model or {primary,fallbacks}). Use this to run compaction on a cheaper or larger-context model without changing regular reply model selection.",
